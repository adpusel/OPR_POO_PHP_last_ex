...
class NewsController extends BackController
{
  public function executeIndex(HTTPRequest $request)
  {
	...
	$this->page->addVar('title',
	  'Liste des ' . $nombreNews . ' dernières news');
  ...
  {
	$news =
	  $this->managers->getManagerOf('News')->getUnique($request->getData('id'));
  ...
  public function executeInsertComment(HTTPRequest $request)
  {
	...
	$formHandler =
	  new FormHandler($form, $this->managers->getManagerOf('Comments'),
		$request);
